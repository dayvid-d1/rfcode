...
curl -o rf-image.sh https://github.com/dayvid-d1/rfcode/blob/master/install/rf-image.sh
chmod +x ./rf-image.sh
./rf-image.sh \
    -i ${RF_IMAGE} \
    -t ${ROBOT_THREADS} \        
...
curl -o caddy-image.sh https://github.com/dayvid-d1/caddy/blob/master/caddy-image.sh
